export const ABI_CONTROLLER = [
  {
    inputs: [
      ...
      { internalType: "address[]", name: "fyDais", type: "address[]" }
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "collateral", type: "bytes32" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "user", type: "address" },
      { internalType: "bytes4[]", name: "signatures", type: "bytes4[]" }
    ],
    name: "batchOrchestrate",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "fyDaiAmount", type: "uint256" }
    ],
    name: "borrow",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "user", type: "address" },
      { internalType: "bytes4", name: "signature", type: "bytes4" }
    ],
    name: "orchestrate",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [],
    name: "pot",
    outputs: [{ internalType: "contract IPot", name: "", type: "address" }],
    stateMutability: "view",
    type: "function"
  },
  {
  ...
  },
  {
    ...
    name: "series",
    outputs: [{ internalType: "contract IFYDai", name: "", type: "address" }],
    stateMutability: "view",
    type: "function"
  },
  {
...
export const ABI_LIQUIDATIONS = [
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "from", type: "address" },
      { internalType: "address", name: "to", type: "address" },
      { internalType: "address", name: "liquidated", type: "address" },
      { internalType: "uint256", name: "daiAmount", type: "uint256" }
    ],
    name: "buy",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
